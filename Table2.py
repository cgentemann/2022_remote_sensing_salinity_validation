#!/usr/bin/env python
##This script calculates the values in Table 2 
import xarray as xr
import numpy as np
...
data_dir2 = '~/hycom_files/'

files = glob(data_dir2+'*nc4')
hycom=xr.open_mfdataset(data_dir2+'*nc4',concat_dim='time').isel(depth=0)

...
ax1.text(-72, 2.55, 'a)', fontsize=10)
...
ax2.text(-72, 2.55, 'b)', fontsize=10)
...
ax3.text(-72, 2.55, 'c)', fontsize=10)
...
ax4.text(-72, 2.55, 'd)', fontsize=10)
...
ax5.text(-72, 2.55, 'e)', fontsize=10)
...
ax6.text(-72, 2.55, 'f)', fontsize=10)
...
ax7.text(-72, 2.55, 'g)', fontsize=10)
...
ax8.text(-72, 2.55, 'h)', fontsize=10)
...
ax9.text(-72, 2.55, 'i)', fontsize=10)
...
ax10.text(-72, 2.55, 'j)', fontsize=10)
...
# plt.savefig('C:\\Users\\khall\\Documents\\GitHub\\paper_software\\2020_ATOMIC_Salinity\\figures\\GIFsubplots.png', bbox_inches='tight')
plt.show()
